                                ...
                                <div class="ph-form-wrapper">
                                    <form id="signupForm" action="" method="POST">
                                        ...
                                        <div class="ph-half">
                                            ...
                                            <div class="ph-input-wrapper">
                                                <input type="text" name="phonenumber" id="signupPhoneNumber" placeholder="+977 987-6543210">
                                            </div>
                                        </div>
                                        <div class="ph-half">
                                            <div class="ph-input-wrapper">
                                            ...
                                            <div class="ph-input-wrapper">
                                                <input type="password" name="confirm_password" id="signupPasswordRe" placeholder="********">
                                            </div>
                                        </div>
                                        <div class="ph-input-wrapper">
