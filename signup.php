                                    ...
                                    <div class="ph-form-wrapper">                                
                                        <form id="signupForm" action="" method="POST">
                                            <div class="ph-input-wrapper">
                                                <input type="text" name="fullname" id="signupName" placeholder="John Doe" required >
                                            </div>
                                            <div class="ph-half">                                                
                                                <div class="ph-input-wrapper">
                                                    <input type="email" name="email" id="signupEmail" placeholder="example@gemail.com" required>
                                                </div>
                                                <div class="ph-input-wrapper">
                                                    <input type="number" name="phonenumber" id="signupPhoneNumber" placeholder="+977 987-6543210" required>
                                                </div>
                                            </div>
                                            <div class="ph-half">                                                
                                                <div class="ph-input-wrapper">
                                                ...
                                                <div class="ph-input-wrapper">
                                                    <input type="cpassword" name="password" id="signupPasswordRe" placeholder="********" required>
                                                </div>
                                            </div>
                                            <div class="ph-input-wrapper">
                                                <input class="ph-btn ph-btn__form" name="submit" type="submit" value="Sign Up" id="form-submit">
                                            </div>
                                        </form>
